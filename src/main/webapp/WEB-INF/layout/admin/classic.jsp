...
<html>
    ...
    <head>
        ...
        <!-- libraries -->
        <link href="<%=Util.T1_%>css/lib/jquery-ui-1.10.2.custom.css" rel="stylesheet" type="text/css" />
        <link href="<%=Util.T1_%>css/lib/font-awesome.css" type="text/css" rel="stylesheet" />
        ...
        <link rel="stylesheet" href="<%=Util.T1_%>css/compiled/index.css" type="text/css" media="screen" />
    ...
    <body>
        ...
        <script src="<%=Util.T1_%>js/jquery-ui-1.10.2.custom.min.js"></script>
        <!-- knob -->
        <script src="<%=Util.T1_%>js/jquery.knob.js"></script>
        <!-- flot charts -->
        <script src="<%=Util.T1_%>js/jquery.flot.js"></script>
        <script src="<%=Util.T1_%>js/jquery.flot.stack.js"></script>
        <script src="<%=Util.T1_%>js/jquery.flot.resize.js"></script>
