        ...
        <div class="col-md-12">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="first">
                        <td>
                            <img src="<%=Util.T1_%>img/contact-img.png" alt="contact" class="img-circle avatar hidden-phone">
                    ...
                    <tr>
                        <td>
                            <img src="<%=Util.T1_%>img/contact-img2.png" alt="contact" class="img-circle avatar hidden-phone">
                            <a href="user-profile.html" class="name">Alejandra Galvan Castillo</a>
                            <span class="subtext">Graphic Design</span>
                        </td>
                        <td>
